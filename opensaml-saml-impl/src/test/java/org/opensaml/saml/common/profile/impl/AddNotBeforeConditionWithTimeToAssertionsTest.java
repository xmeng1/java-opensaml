...
public class AddNotBeforeConditionWithTimeToAssertionsTest extends OpenSAMLInitBaseTestCase {

    private ProfileRequestContext prc;
    
    private AddNotBeforeConditionWithTimeToAssertions action;
    ...
    public void setUp() throws ComponentInitializationException {
        ...
        action = new AddNotBeforeConditionWithTimeToAssertions();
        action.initialize();
    }
